...
const TATodayAttendance = () => {
  ...
  // State to store the attendance code generated by TA
  const [attendanceString, setAttendanceString] = useState<AttendanceString>();
  // State to store the attendance list of students for today's session
  ...
  // Checks if attendance code is already generated, to prevent duplicate codes
  ...
  // Generate attendance code for the session
  ...
  // Fetch attendance code or attendance list based on the timer
